...
Ntot = calc_n_neuron(density[('M1','SOM')][5], 620 - 300) + \
       calc_n_neuron(density[('M1','SOM')][2], 300 - 190) + \
       calc_n_neuron(density[('M1','SOM')][3], 190 + 190) + \
       calc_n_neuron(density[('M1','SOM')][4], -190 + 425)
